...
myKeys home conf@(XConfig { modMask = modMask }) =
  ...
  -- espeak
  , ((0,                        xK_F9     ), spawn $ home ++ ".xmonad/scripts/speek.sh speek")
  , ((shiftMask,                xK_F9     ), spawn $ home ++ ".xmonad/scripts/speek.sh -lno speek")
  , ((0,                        xK_F10    ), spawn $ home ++ ".xmonad/scripts/speek.sh stop")
