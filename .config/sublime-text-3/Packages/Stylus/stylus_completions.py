...
class CSSCompletions(sublime_plugin.EventListener):
    ...
    def on_query_completions(self, view, prefix, locations):
        if not view.match_selector(locations[0], "source.stylus - meta.selector.stylus"):
            return []
        ...
        l = []
        if (view.match_selector(locations[0], "meta.property-value.stylus") or
            # This will catch scenarios like .foo {font-style: |}
            view.match_selector(locations[0] - 1, "meta.property-value.stylus")):
            ...
            add_colon = not view.match_selector(locations[0], "meta.property-name.stylus")
